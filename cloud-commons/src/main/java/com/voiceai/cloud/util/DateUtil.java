...
public class DateUtil {
    ...
    public static String parseDate2DateString(Date date) {
        return parseDateToStr(date, DATE_FORMAT_YYYYMMDD);
    }

    public static String parseCurrent2DateString() {
        return parseDate2DateString(new Date());
    }
}
